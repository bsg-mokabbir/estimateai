...
from rnd.document_classification.inference_pdf_classifier import extract_all_drawings
...
class PDFProcessor:
    ...
    def process_pdf(self, pdf_file):
        ...
        try:
            ...
            # Extract drawings using your existing code
            with st.spinner('📄 Processing PDF and extracting pages...'):
                # You'll need to modify extract_all_drawings to accept output folder parameter
                # For now, assuming it creates files in dynamic_extracted folder
                drawings = extract_all_drawings(temp_pdf_path)
